...
import cv from '../assets/docs/gilisinai.pdf'

class Intro extends Component {
    render() {
        
        return (
            <div className={`container full-height flex-container`} id="section1" onClick={this.props.closePicker}>
                ...
                <div className="flex-container btn-wrapper">
                    <a href="https://wa.me/+972523585752 " className={`btn flex-container space-evenly mr-sm `}>
                    ...
                    <a href="mailto:gilisinai2016@gmail.com" className={`btn flex-container space-evenly mr-sm`}>
                    ...
                    <a href={cv} className={`btn flex-container space-evenly mr-sm`} download={cv}>
